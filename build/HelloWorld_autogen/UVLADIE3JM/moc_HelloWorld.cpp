...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_HelloWorld_t, stringdata0) + ofs), len 
...
const QMetaObject HelloWorld::staticMetaObject = { {
    ...
    qt_meta_stringdata_HelloWorld.offsetsAndSize,
    qt_meta_data_HelloWorld,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_HelloWorld_t
