...
#ifndef GOOGLE_PROTOBUF_INCLUDED_t3_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_t3_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_t3_2eproto
...
struct TableStruct_t3_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_t3_2eproto;
class Process;
...
class Process final :
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_t3_2eproto;
};
// ===================================================================
...
inline const std::string& Process::name() const {
  // @@protoc_insertion_point(field_get:Process.name)
...
void Process::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Process.name)
}
inline std::string* Process::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:Process.name)
  return _s;
}
...
inline std::string* Process::release_name() {
  // @@protoc_insertion_point(field_release:Process.name)
...
inline void Process::set_allocated_name(std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Process.name)
}
...
inline int32_t Process::pid() const {
  // @@protoc_insertion_point(field_get:Process.pid)
...
inline void Process::set_pid(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:Process.pid)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_t3_2eproto
