...
static ::_pb::Metadata file_level_metadata_t3_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_t3_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_t3_2eproto = nullptr;

const uint32_t TableStruct_t3_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::Process, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::Process, _impl_.pid_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Process)},
};
...
const char descriptor_table_protodef_t3_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\010t3.proto\"$\n\007Process\022\014\n\004name\030\001 \001(\t\022\013\n\003p"
  "id\030\002 \001(\005b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_t3_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_t3_2eproto = {
    false, false, 56, descriptor_table_protodef_t3_2eproto,
    "t3.proto",
    &descriptor_table_t3_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_t3_2eproto::offsets,
    file_level_metadata_t3_2eproto, file_level_enum_descriptors_t3_2eproto,
    file_level_service_descriptors_t3_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_t3_2eproto_getter() {
  return &descriptor_table_t3_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_t3_2eproto(&descriptor_table_t3_2eproto);
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Process.name"));
        } else
          goto handle_unusual;
        continue;
      // int32 pid = 2;
...
::PROTOBUF_NAMESPACE_ID::Metadata Process::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_t3_2eproto_getter, &descriptor_table_t3_2eproto_once,
      file_level_metadata_t3_2eproto[0]);
}

// @@protoc_insertion_point(namespace_scope)
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::Process*
Arena::CreateMaybeMessage< ::Process >(Arena* arena) {
