...
public:
    ...
    */
     ...
     * $ root 2 $ 文件夹1 3 $ 文件夹2 1 $ 文件1的id $ 文件2的id $ 文件3的id $ 文件4的id $
     * tip qa1： 新建文件夹发生了什么
     * tip 进程系统传入一个路径，比如root/文件夹3
     * tip 文件系统根据路径，找到root，然后root下新建一个文件夹，名字为文件夹3
     * 更新目录信息：root 3 $ 文件夹1 3 $ 文件夹2 1 $ 文件夹3 0 $ 文件1的id $ 文件2的id $ 文件3的id $ 文件4的id $
     * 调用内存的存储目录信息。
     */
